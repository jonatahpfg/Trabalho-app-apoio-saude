...
def test_adiciona_usuario_quando_dados_validos(
    gerenciador,
):
...
def test_rejeita_usuario_quando_cpf_vazio(
    gerenciador,
):
...
def test_rejeita_usuario_quando_cpf_duplicado(
    gerenciador,
):
    dados = dict(
        nome="Ana",
...
def test_rejeita_usuario_quando_login_duplicado(
    gerenciador,
):
    gerenciador.adicionar_usuario(
        nome="Ana",
...
def test_lista_todos_os_usuarios_cadastrados(
    gerenciador,
):
    gerenciador.adicionar_usuario(
        nome="Ana",
...
def test_retorna_lista_vazia_quando_nao_ha_usuarios(
    gerenciador,
):
